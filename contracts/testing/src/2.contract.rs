                    ...
                    Some(_data) => {
                        ...
                        match attr {
                            Some(data) => {
                                ...
                                let query_allowance: Result<cw20::AllowanceResponse, _> =
                                    app.wrap().query_wasm_smart(
                                        &data.value,
                                ...
                                let execute_swap_token = app.execute_contract(
                                    liquidity_provider.clone(),
                                    vault_contract_address.clone(),
                                    &vault::msg::ExecuteMsg::SwapTokens,
                                );
                            }
